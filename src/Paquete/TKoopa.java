...
public class TKoopa extends TEnemigo{
	/**
	 * velocidad del proyectil cuando se salta encima de
	 */
	...
	public void heroeContacto(Heroe heroe){
		...
		//el caparazón está parado
		if(vCaparazon && vel.x == 0){
			//proyectarse hacia donde quiera.
		...
		//pisando a los koopa que caminan || pisando el caparazón que se mueve
	...
	public void thingTouch(Thing t){
		...
		if((where & DE_LADO) > 0 && t instanceof TEnemigo && vCaparazon && vel.x != 0){ //chocó con un enemigo en movimiento para matar
